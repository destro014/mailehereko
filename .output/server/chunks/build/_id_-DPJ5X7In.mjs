import { _ as __nuxt_component_0, a as __nuxt_component_1 } from './DetailsWrapper-DXRUp-sW.mjs';
import { withAsyncContext, mergeProps, unref, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent } from 'vue/server-renderer';
import { u as useRoute, a as useRouter, n as navigateTo, b as useRuntimeConfig } from './server.mjs';
import { u as useHead } from './v3-BfSsVMP_.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const { data: item, error } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData("tv-details", async () => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "tv-show-details-page page container" }, _attrs))}>`);
...
//# sourceMappingURL=_id_-DPJ5X7In.mjs.map
