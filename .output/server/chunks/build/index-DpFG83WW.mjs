...
import { _ as __nuxt_component_1, a as _sfc_main$2 } from './Card-D-06xRdd.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const filteredList = computed(() => {
      return lists.value.filter((item) => {
        if (item.media_type === "movie") {
          return item.original_title.toLowerCase().includes(stateSearchTerm.value.toLowerCase());
        }
      });
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "movies-page page container" }, _attrs))}><div class="header"><div class="breadcrumb-container">`);
      ...
      _push(`</div><h1>Movies</h1><div class="search-wrapper">`);
      ...
      _push(`</div></div><p>${ssrInterpolate(filteredList.value.length)} items</p>`);
      if (loading.value) {
...
//# sourceMappingURL=index-DpFG83WW.mjs.map
