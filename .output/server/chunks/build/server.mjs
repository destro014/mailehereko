import { defineComponent, inject, ref, h, Suspense, hasInjectionContext, getCurrentInstance, computed, unref, provide, watch, shallowReactive, Fragment, createElementBlock, shallowRef, cloneVNode, defineAsyncComponent, createApp, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext } from 'vue';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DG2lSnij.mjs')
  },
  {
    name: "tv-id",
    path: "/tv/:id()",
    component: () => import('./_id_-DPJ5X7In.mjs')
  },
  {
    name: "admin-add",
    path: "/admin/add",
    meta: { "middleware": "auth" },
    component: () => import('./add-CJzjyd-m.mjs')
  },
  {
    name: "movie-id",
    path: "/movie/:id()",
    component: () => import('./_id_-B1sy6wVu.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: { "middleware": "auth" },
    component: () => import('./index-DpKL8t0X.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./index--iJ7_3Aq.mjs')
  },
  {
    name: "movies",
    path: "/movies",
    component: () => import('./index-DpFG83WW.mjs')
  },
  {
    name: "suggest",
    path: "/suggest",
    component: () => import('./index-Dgt-a3n5.mjs')
  },
  {
    name: "tvshows",
    path: "/tvshows",
    component: () => import('./index-4rOFVaCh.mjs')
  },
  {
    name: "admin-suggestions",
    path: "/admin/suggestions",
    meta: { "middleware": "auth" },
    component: () => import('./suggestions-Bq15c3Z3.mjs')
  }
];
...
const namedMiddleware = {
  auth: () => import('./auth-CxnX7WYw.mjs'),
  authenticated: () => import('./authenticated-9HZ3mXR4.mjs')
};
...
const firebase_kpjecCMkOtWi_NG312RLEsvaIkhwsdrV5WIoE0vCPpA = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DnycrDCE.mjs').then((m) => m.default || m)),
  "error-layout": defineAsyncComponent(() => import('./error-layout-DskP7V9N.mjs').then((m) => m.default || m)),
  error: defineAsyncComponent(() => import('./error-CoT_WC1W.mjs').then((m) => m.default || m)),
  fullpage: defineAsyncComponent(() => import('./fullpage-BAT7fK1Y.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-COmwugwS.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-ONb8fkbK.mjs'));
...
export { _export_sfc as _, useRouter as a, useRuntimeConfig as b, useRequestFetch as c, useNuxtApp as d, entry$1 as default, asyncDataDefaults as e, fetchDefaults as f, createError as g, defineNuxtRouteMiddleware as h, __nuxt_component_1 as i, useRouter$1 as j, nuxtLinkDefaults as k, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRoute as u };
