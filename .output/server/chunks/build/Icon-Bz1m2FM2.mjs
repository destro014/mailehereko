...
`;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<i${ssrRenderAttrs(mergeProps({
        class: ["mh-icon", `icon-` + __props.name]
      }, _attrs))}>${(_a = icon.value) != null ? _a : ""}</i>`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/core/Icon.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as _ };
//# sourceMappingURL=Icon-Bz1m2FM2.mjs.map
