import{e as r,c as i,o as n,V as s}from"./CJZBxJVY.js";const d=["innerHTML"],l={__name:"Icon",props:{name:String,size:String},setup(e){const t=e,o=r(()=>{switch(t.name){case"arrow-right":return`<svg width="24" height="24" viewBox="0 0 24 24">
      ...
      </svg>`;case"movie":return`<svg width="24" height="24" viewBox="0 0 24 24">
        ...
        <path d="M9.75 14.45V13.25C9.75 11.71 10.84 11.08 12.17 11.85L13.21 12.45L14.25 13.05C15.58 13.82 15.58 15.08 14.25 15.85L13.21 16.45L12.17 17.05C10.84 17.82 9.75 17.19 9.75 15.65V14.45V14.45Z" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>`;case"link":return`<svg width="24" height="24" viewBox="0 0 24 24" >
      ...
      </svg>`;case"close":return`<svg width="24" height="24" viewBox="0 0 24 24">
        <path d="M7.75732 7.75735L16.2426 16.2426" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M7.75732 16.2426L16.2426 7.75735" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>`;case"thumbs-up":return`<svg width="24" height="24" viewBox="0 0 24 24">
        ...
        <path d="M2.37988 18.35V8.55002C2.37988 7.15002 2.97988 6.65002 4.37988 6.65002H5.37988C6.77988 6.65002 7.37988 7.15002 7.37988 8.55002V18.35C7.37988 19.75 6.77988 20.25 5.37988 20.25H4.37988C2.97988 20.25 2.37988 19.75 2.37988 18.35Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>`;case"plus":return`<svg width="24" height="24" viewBox="0 0 24 24" >
      ...
      </svg>`;case"added":return`<svg width="24" height="24" viewBox="0 0 24 24">
<path d="M7.75 12L10.58 14.83L16.25 9.17004" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`;case"watched":return`<svg width="24" height="24" viewBox="0 0 24 24" >
        <path d="M22 9V15C22 15.22 22 15.44 21.98 15.65C21.16 14.64 19.91 14 18.5 14C17.44 14 16.46 14.37 15.69 14.99C14.65 15.81 14 17.08 14 18.5C14 19.34 14.24 20.14 14.65 20.82C14.92 21.27 15.26 21.66 15.66 21.98C15.45 22 15.23 22 15 22H9C4 22 2 20 2 15V9C2 4 4 2 9 2H15C20 2 22 4 22 9Z"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M2.52002 7.10999H21.48"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M8.52002 2.10999V6.96997"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M15.48 2.10999V6.52002"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M23 18.5C23 19.34 22.76 20.14 22.35 20.82C22.11 21.22 21.81 21.58 21.46 21.88C20.67 22.58 19.64 23 18.5 23C17.43 23 16.44 22.62 15.67 21.98H15.66C15.26 21.66 14.92 21.27 14.65 20.82C14.24 20.14 14 19.34 14 18.5C14 17.08 14.65 15.81 15.69 14.99C16.46 14.37 17.44 14 18.5 14C19.91 14 21.16 14.64 21.98 15.65C22.62 16.42 23 17.42 23 18.5Z"  stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M16.75 18.5L17.86 19.61L20.26 17.39"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>`;case"star":return`<svg width="24" height="24" viewBox="0 0 24 24">
      ...
      </svg>`;case"logout":return`<svg width="24" height="24" viewBox="0 0 24 24">
        <path d="M17.44 14.62L20 12.06L17.44 9.5" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      </svg>`;case"search":return`<svg width="24" height="24" viewBox="0 0 24 24">
      ...
      </svg>`;case"user":return`<svg width="24" height="24" viewBox="0 0 24 24">
        <path d="M18.1404 21.62C17.2604 21.88 16.2204 22 15.0004 22H9.00035C7.78035 22 6.74035 21.88 5.86035 21.62C6.08035 19.02 8.75035 16.97 12.0004 16.97C15.2504 16.97 17.9204 19.02 18.1404 21.62Z"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <path d="M15.5799 10.58C15.5799 12.56 13.9799 14.17 11.9999 14.17C10.0199 14.17 8.41992 12.56 8.41992 10.58C8.41992 8.60002 10.0199 7 11.9999 7C13.9799 7 15.5799 8.60002 15.5799 10.58Z"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>`;case"email":return`<svg width="24" height="24" viewBox="0 0 24 24" >
      ...
      </svg>`;case"password":return`<svg width="24" height="24" viewBox="0 0 24 24" >
        ...
        <path d="M16.2802 13.61C15.1502 14.74 13.5302 15.09 12.1002 14.64L9.5102 17.22C9.3302 17.41 8.9602 17.53 8.6902 17.49L7.4902 17.33C7.0902 17.28 6.7302 16.9 6.6702 16.51L6.5102 15.31C6.4702 15.05 6.6002 14.68 6.7802 14.49L9.3602 11.91C8.9202 10.48 9.2602 8.86001 10.3902 7.73001C12.0102 6.11001 14.6502 6.11001 16.2802 7.73001C17.9002 9.34001 17.9002 11.98 16.2802 13.61Z"  stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M10.4496 16.28L9.59961 15.42"  stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M13.3949 10.7H13.4039"  stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>`;case"eye-open":return`<svg width="24" height="24" viewBox="0 0 24 24" >
        ...
        <path d="M11.9998 20.27C15.5298 20.27 18.8198 18.19 21.1098 14.59C22.0098 13.18 22.0098 10.81 21.1098 9.39997C18.8198 5.79997 15.5298 3.71997 11.9998 3.71997C8.46984 3.71997 5.17984 5.79997 2.88984 9.39997C1.98984 10.81 1.98984 13.18 2.88984 14.59C5.17984 18.19 8.46984 20.27 11.9998 20.27Z"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>`;case"eye-close":return`<svg width="24" height="24" viewBox="0 0 24 24" >
        <path d="M14.5299 9.47004L9.46992 14.53C8.81992 13.88 8.41992 12.99 8.41992 12C8.41992 10.02 10.0199 8.42004 11.9999 8.42004C12.9899 8.42004 13.8799 8.82004 14.5299 9.47004Z"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <path d="M8.41992 19.5301C9.55992 20.0101 10.7699 20.2701 11.9999 20.2701C15.5299 20.2701 18.8199 18.1901 21.1099 14.5901C22.0099 13.1801 22.0099 10.8101 21.1099 9.40005C20.7799 8.88005 20.4199 8.39005 20.0499 7.93005"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M15.5104 12.7C15.2504 14.11 14.1004 15.26 12.6904 15.52"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      </svg>`;case"filter":return`<svg width="24" height="24" viewBox="0 0 24 24" >
        <path d="M5.40039 2.09998H18.6004C19.7004 2.09998 20.6004 2.99998 20.6004 4.09998V6.29998C20.6004 7.09998 20.1004 8.09998 19.6004 8.59998L15.3004 12.4C14.7004 12.9 14.3004 13.9 14.3004 14.7V19C14.3004 19.6 13.9004 20.4 13.4004 20.7L12.0004 21.6C10.7004 22.4 8.90039 21.5 8.90039 19.9V14.6C8.90039 13.9 8.50039 13 8.10039 12.5L4.30039 8.49998C3.80039 7.99998 3.40039 7.09998 3.40039 6.49998V4.19998C3.40039 2.99998 4.30039 2.09998 5.40039 2.09998Z"  stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M10.93 2.09998L6 9.99998"  stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>`;case"menu":return`<svg width="24" height="24" viewBox="0 0 24 24">
      ...
      </svg>`;default:return""}});return(k,h)=>(n(),i("i",{class:s(["mh-icon","icon-"+e.name]),innerHTML:o.value},null,10,d))}};export{l as _};
